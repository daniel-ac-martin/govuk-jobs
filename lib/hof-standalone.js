...
const HOFBaseController = hof.controllers.base;
const ErrorClass = hof.controllers.error;
...
class StandaloneController extends HOFBaseController {
  ...
  get(req, res, callback) {
    const submitted = _.intersection(
  ...
  setErrors(err, req) {
    const errorValues = req.form ? req.form.values : undefined;
